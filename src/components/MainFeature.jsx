      ...
      >
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
          <div className="space-y-2 flex flex-col items-center">
            ...
            <div>
              <h4 className="text-sm font-medium text-surface-800 dark:text-surface-200">Precision Training</h4>
              <p className="text-xs text-surface-600 dark:text-surface-400">Targeted workout programs</p>
            </div>
          </div>
          <div className="space-y-2 flex flex-col items-center">
            <ZapIcon className="h-8 w-8 text-primary" />
            <div>
              <h4 className="text-sm font-medium text-surface-800 dark:text-surface-200">High Performance</h4>
              <p className="text-xs text-surface-600 dark:text-surface-400">Optimized for results</p>
            </div>
          </div>
          <div className="space-y-2 flex flex-col items-center">
            <ShieldIcon className="h-8 w-8 text-primary" />
            <div>
              <h4 className="text-sm font-medium text-surface-800 dark:text-surface-200">Secure Access</h4>
              <p className="text-xs text-surface-600 dark:text-surface-400">Protected user data</p>
            </div>
          </div>
        </div>
      </motion.div>
